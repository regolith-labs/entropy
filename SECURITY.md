...
### Reporting security problems in the Entropy contract

**DO NOT CREATE A GITHUB ISSUE** to report a security problem.

Instead please use this [Report a Vulnerability](https://github.com/regolith-labs/entropy/security/advisories/new) link.
