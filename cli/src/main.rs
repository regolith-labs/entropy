...
async fn main() {
    ...
    let command = args.get(1).expect("Usage: entropy-cli <init|sample|var|lut>");
    ...
    match command.as_str() {
        ...
        _ => {
            ...
            eprintln!("Usage: entropy-cli <init|sample|var|lut>");
            std::process::exit(1);
        }
    }
}
...
async fn sample_v0(
    ...
    // Build v0 message with lookup table.
    let blockhash = rpc
